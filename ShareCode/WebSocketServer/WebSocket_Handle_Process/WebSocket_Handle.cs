...
using static Saker.IO.FileHelper;
using Saker.Tools;

using static Saker.SystemErrorProvide;
using Saker.Web;
using Saker.IO;

namespace Saker.WebSocketServer
{
...
{body}";
    ...
    internal static class WebsocketDebug
    {
        ...
        static readonly MessageQueue<string> Logic = new Saker.Tools.MessageQueue<string>();
