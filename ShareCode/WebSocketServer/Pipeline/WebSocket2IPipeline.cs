...
namespace Saker.WebSocketServer.Pipeline
{ 
...
#pragma warning disable CS1591
        ...
        public bool Connected => this.session?.BaseSocket?.Connected == true;
        public string IPAdress => this.session?.ClientAddress ?? "";
        public uint IPAdressUInt32 => this.session.BaseSocket.IPAdressUInt32;
        public bool IsSetRemoteIP => this.session.BaseSocket.IsSetRemoteIP;
        public int Port => this.session.BaseSocket.Port;
        ...
        {
            this.session.BaseSocket.SetRemoteIP(ip);
        }
        public bool StartReceive()
        {
            return this.session.BaseSocket.StartReceive();
        }
