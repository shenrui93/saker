...
using Saker.Serialization;
using Saker.Extension;

namespace Saker.Web.Session
{
    /// <summary>
    /// 提供对象基础验证和序列化操作
    /// </summary>
    /// <typeparam name="T"></typeparam>
    [Saker.Serialization.PacketContract]
        ...
        where T : class, IDataEncryption, new()
    {
        ...
        {
            serializer = Saker.Serialization.BinarySerializer.GetTypeSerializer(typeof(T));
            if (serializer == null)
