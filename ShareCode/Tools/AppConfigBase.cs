...
namespace Saker.Tools
{
        ...
        where HostType : class, IAppConfigBase, new()
    {
        ...
        {
            configfilename = Saker.IO.FileHelper. ProcessName;
        }
        ...
        {
            var json = Saker.Serialization.Json.JsonHelper.ToFormatJson(this);
            var path = ConfigPath;
            if (File.Exists(path))
            {
                File.Delete(path);
        ...
        public static string ConfigPath
        {
            get
            {
                return $"{ Saker.IO.FileHelper.ProcessBaseDir}/{configfilename}.apconf";
            }
        }
        /// <summary>
        /// 
