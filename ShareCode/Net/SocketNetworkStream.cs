...
namespace Saker.Net
{
    ...
    public sealed class SocketNetworkStream : Stream, IDisposable
    {
        ...
        {
            return InternalBeginRead(buffer, offset, count, callback, state, Saker.DefaultValueManager.BoolEmptyCall);
        }
        /// <summary>
        /// 开始一个异步写入数据操作
        /// </summary>
        ...
        {
            return InternalBeginWrite(buffer, offset, count, callback, state, Saker.DefaultValueManager.BoolEmptyCall);
        }
